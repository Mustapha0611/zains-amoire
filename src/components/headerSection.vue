<template>
  ...
  >
    ...
    <nav class="flex-2">
      <ul
        class="flex md:justify-start justify-center md:items-start transition-all items-center text-slate-50 md:text-slate-800 font-semibold md:flex-row flex-col md:relative absolute w-full h-[100dvh] md:h-12 -left-[100%] md:transform-none top-0 md:left-0 bg-black md:bg-white z-50"
        :class="{ show: showMenu }"
      >
        <span
          class="md:hidden absolute top-5 right-5 w-5 text-lime-100 cursor-pointer"
          @click="toggleMenu"
          >
